...
show_node_link() {
    ...
    NODE_LINK="vless://$UUID@$domain:$PORT?type=tcp&security=reality&encryption=none&flow=xtls-rprx-vision&pbk=$PUBLIC_KEY&sni=$domain&sid=$SHORT_ID#vless+Reality$username"
    echo "节点链接: $NODE_LINK"
}
